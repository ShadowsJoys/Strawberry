...
public class Plot : MonoBehaviour, IPointerClickHandler
{
    ...
    static public bool check, point;
    ...
    void Update()
    {
        ...
        if (!point)
        {
            check = StrawberryScript.checkpoint;
     ...
     public void OnPointerClick(PointerEventData eventdata)
    {
        ...
        else if (dia == 15)
        {
            if (next)
            {
                strawbText.text = "See, you're currently in the Game tab. You can see it just below the play button and to the left.";
                dia++;
            }
        }
        else if (dia == 16)
        ...
        else if (dia == 57)
        {
            if (next)
            {
                ...
                //Change the dialogue above and comment the line below back in for your final strawberry!
                    //(I explained commenting things out and in at the top of this file)
                strawberry.SetActive(true);
                nx.SetActive(false);
            }
        }
